...
This plugin enables **support** for `.PID` image files from the 1999 game **Gruntz** in **Dragon UnPACKer 5**. It allows:
...
**Cause:**  
Maybe Dragon UnPACKer 5 incorrectly identifies some `.PID` files as **TGA** due to similar headers or internal driver bugs. It attempts to use its **built-in TGA previewer**, which crashes on invalid data.
